...
public class main {
	public static void main(String args[]) {
		SolutionAll solution = new SolutionAll();
...
//		int target = 3;
//		boolean result =solution.searchII(nums, target);
...
//		int x = 3;
//
//		ListNode head = fromArrays(nums, 0);
//
...
//
//		List<List<String>> result = solution.findLaddersShortestLength(beginWord, endWord, wordList);
...
//	private static ListNode fromArrays(int[] nums, int index) {
...
//
//		head.next = fromArrays(nums, index + 1);
//
//		return head;
//	}
}
